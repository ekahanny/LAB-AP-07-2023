...
def isi_trx_history(): #nomor 3
    '''MEMBUAT ISI ATAU BAGIAN DARI HISTORI TRANSAKSI'''
    global total_keseluruhan #Global : untuk dapat mengambil variabel yang dari luar, dan dipanggil kedalam tanpa menjadikannya parameter
...
def awal_struk(FileStruk, NamaKasir, tampung): #nomor 2
